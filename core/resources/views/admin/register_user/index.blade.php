                            ...
                            <table class="table table-striped mt-3">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="{{$user->photo ? asset('assets/front/img/user/'.$user->photo) : ''}}"
                                                alt=""></td>
                                        <td>
                                            {{$user->number}}
                                        </td>
                                        ...
                                        <td>
                                            <a href="{{route('register.user.view',$user->id)}}"
                                                class="btn btn-primary btn-sm editbtn"><i class="fas fa-eye"></i>
                                                View</a>
                                        </td>
                                        <td>
                                            <form id="userFrom{{$user->id}}" class="d-inline-block"
                                                ...
                                                @csrf
                                                <select
                                                    class="form-control {{$user->status == 1 ? 'bg-success' : 'bg-danger'}}"
                                                    name="status"

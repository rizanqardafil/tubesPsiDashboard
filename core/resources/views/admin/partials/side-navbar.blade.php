    ...
    <div class="sidebar-wrapper scrollbar scrollbar-inner">
        <div class="sidebar-content">
                        ...
                        <ul class="nav nav-collapse">
                            ...
                            <li class="submenu">
                                <a data-toggle="collapse" href="#emailset"
                                    aria-expanded="{{(request()->path() == 'admin/mail-from-admin' || request()->path() == 'admin/mail-to-admin') ? 'true' : 'false' }}">
                                    <span class="sub-item">Email Settings</span>
                                    <span class="caret"></span>
                                </a>
                                <div class="collapse {{(request()->path() == 'admin/mail-from-admin' || request()->path() == 'admin/mail-to-admin') ? 'show' : '' }}"
                                    id="emailset">
         ...
         @endif">
          ...
          @elseif(request()->path() == 'admin/product/grafik/orders') active
          @endif">
            ...
            @elseif(request()->path() == 'admin/product/grafik/orders') show
            @endif" id="category">
                        <ul class="nav nav-collapse">
                            <li class="
                @if(request()->path() == 'admin/category') active
                ...
                @endif">
                            ...
                            <li class="@if(request()->path() == 'admin/product/grafik/orders') active @endif">
                                <a href="{{route('admin.grafik.product.orders')}}">
                                    <span class="sub-item">Grafik Orders</span>
                                </a>
                            </li>
                        </ul>
                    </div>
           ...
           @endif">
                ...
                <!--  Statistic-->
                @if (empty($admin->role) || (!empty($permissions) && in_array('Statistic', $permissions)))
                {{-- Statistic --}}
                <li class="nav-item
           @if(request()->path() == 'admin/statistic') active
           @endif">
